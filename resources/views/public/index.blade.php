...
<head>
    ...
    <link href="{{"assets"}}/public/css/flaticon.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/slick-slider.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/prettyphoto.css" rel="stylesheet">
    <link href="{{"assets"}}/public/build/mediaelementplayer.css" rel="stylesheet">
    <link href="{{"assets"}}/public/style.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/color.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/color-two.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/color-three.css" rel="stylesheet">
    <link href="{{"assets"}}/public/css/color-four.css" rel="stylesheet">
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <ul class="wm-megalist">
                                                        ...
                                                        <li><a href="our-professsors-detail.html">Our Professsors
                                                                Detail</a></li>
                                                        <li><a href="typography-elements.html">Typography Elements</a>
                                                        </li>
                                                        <li><a href="courses-list.html">Courses List</a></li>
                                                        <li><a href="courses-grid.html">Courses Grid</a></li>
...
<script type="text/javascript" src="{{"assets"}}/public/script/bootstrap.min.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/jquery.prettyphoto.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/jquery.countdown.min.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/fitvideo.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/skills.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/slick.slider.min.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/waypoints-min.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/build/mediaelement-and-player.min.js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/isotope.min.js"></script>
<script type="text/javascript" src="s{{"assets"}}/public/cript/jquery.nicescroll.min.js"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js"></script>
<script type="text/javascript" src="{{"assets"}}/public/script/functions.js"></script>
