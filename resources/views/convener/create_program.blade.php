                                    ...
                                    <form id="wizard_with_validation" action="{{ route("programe.store") }}"
                                        ...
                                        <fieldset>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <label class="form-label">Panel Info</label>
                                                    <select name="panel_info" class="form-control" id="">
                                                        <option value="0"> Select One</option>
                                                        @if(!empty($panel_info))
                                                            @foreach($panel_info as $value)
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <label class="form-label">Programe Name*</label>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <textarea name="purpose" class="form-control" id="" cols="30"
                                        ...
                                        <fieldset>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" name="numberOfStudent" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <label class="form-label">Number Of Juges</label>
                                                    <input type="text" name="numberofjudges" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <label class="form-label">Programe Date</label>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <select name="p_method" class="form-control" id="">
                                                        <option value="0"> Select One</option>
                                                    </select>
                                                </div>
                                            </div>
