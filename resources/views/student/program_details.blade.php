                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="card author-box">
                            ...
                            <div class="card-body">
                                <div class="author-box-center">
                                    ...
                                    <div class="author-box-job">{{ $student->department }}</div>
                                </div>
                                <div class="py-4">
                                    <p class="clearfix">
                        ...
                        <div class="card author-box">
                            ...
                            <div class="card-body">
                                <div class="author-box-center">
                                    <div class="clearfix"></div>
                                    <div class="author-box-name pb-4 ">
                                        <a href="#">{{ $program->program_name }}</a>
                                    </div>
                                    <p class="text-left">{{ $program->purpose }}</p>
                                </div>
                                ...
                                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#settings"
                                           role="tab"
                                           aria-selected="false">Edit Project Details</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="about" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12 b-r">
                                                ...
                                                <br>
                                                <p class="text-muted">{{  $program->project_name }}</p>
                                            </div>
                                        ...
                                        <p class="m-t-30"> {{ $program->description }} </p>
                                        <div class="section-title">Supervisor</div>
                                        <ul>
                                            <li>{{ !empty($program->name)?  $program->name: "N/A"  }}</li>
